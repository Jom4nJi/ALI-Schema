    ...
    build(arch, outDir, appOutDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (installerHeader === undefined) {
                ...
                if (resourceList.indexOf("installerHeader.bmp") !== -1) {
            ...
            yield log_1.subTask("Packing app into 7z archive", archive_1.archiveApp(packager.devMetadata.build.compression, "7z", archiveFile, appOutDir, true));
