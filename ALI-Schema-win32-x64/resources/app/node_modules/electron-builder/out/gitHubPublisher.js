...
class GitHubPublisher {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (createReleaseIfNotExists) {
                log_1.log(`Release with tag ${ this.tag } doesn't exists, creating one`);
                return this.createRelease();
            } else {
                log_1.log(`Cannot found release with tag ${ this.tag }, artifacts will be not published`);
                return null;
            }
        });
    }
    ...
    deleteRelease() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            log_1.warn(`Cannot delete release ${ this._releasePromise.value().id }`);
        });
    }
}
