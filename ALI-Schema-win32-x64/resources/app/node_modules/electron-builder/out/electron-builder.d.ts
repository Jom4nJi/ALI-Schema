declare module 'electron-builder/out/appInfo' {
  ...
  export class AppInfo {
    ...
    constructor(metadata: AppMetadata, devMetadata: DevMetadata)
...
declare module 'electron-builder/out/platformPackager' {
  ...
  export abstract class PlatformPackager<DC extends PlatformSpecificBuildOptions> {
    ...
    protected doPack(options: ElectronPackagerOptions, outDir: string, appOutDir: string, arch: Arch, platformSpecificBuildOptions: DC): Promise<void>
    protected computePackOptions(outDir: string, appOutDir: string, arch: Arch): Promise<ElectronPackagerOptions>
    getIconPath(): Promise<string | null>
    ...
    protected getDefaultIcon(ext: string): Promise<string | null>
  }
...
declare module 'electron-builder/out/targets/archive' {
  ...
  export function archiveApp(compression: CompressionLevel | n, format: string, outFile: string, dirToArchive: string, withoutDir?: boolean): Promise<any>
}
...
declare module 'electron-builder/out/targets/fpm' {
  ...
  export class FpmTarget extends Target {
    constructor(name: string, packager: PlatformPackager<LinuxBuildOptions>, cleanupTasks: Array<() => Promise<any>>)
    build(destination: string, target: string, appOutDir: string, arch: Arch): Promise<any>
  }
}
...
declare module 'electron-builder/out/targets/nsis' {
  ...
  export default class NsisTarget extends Target {
    ...
    build(arch: Arch, outDir: string, appOutDir: string): Promise<void>
  }
}
...
declare module 'electron-builder/out/util/util' {
  ...
  export const debug: IDebugger
  export const debug7z: IDebugger
